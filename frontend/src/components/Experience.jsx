...
const ExperienceHeader = ({ role, company, period, location }) => (
  <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
    <div>
      <h3 className="font-display text-2xl font-semibold text-white">{role}</h3>
...
const ExperienceCard = ({ item }) => (
  <article className="reveal relative pl-12 md:pl-16">
    <TimelineDot />
    <div className="glass rounded-2xl p-6 md:p-8 hover:border-cyan-400/30 transition-colors group">
      ...
      />
      <ExperienceBullets bullets={item.bullets} />
